          ...
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(
              imagesAssets + 'update.png',
            ))),
          ),
          const SizedBox(
            height: 24,
          ),
          Text("Update Aplikasi $dialogTitle",
              textAlign: TextAlign.center,
              style: blackTextStyle.copyWith(
                  fontWeight: FontWeight.bold, fontSize: 16, color: blueColor)),
          const SizedBox(
            height: 20,
          ),
          Text("Pastikan kamu mendapatkan fitur terbaru dari $dialogTitle",
              textAlign: TextAlign.center,
              style: blackTextStyle.copyWith(
      ...
      Container(
        ...
        child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              primary: const Color(0xFFEBECEE),
            ),
            onPressed: () {
              Navigator.of(context, rootNavigator: true).pop();
            },
